...
<body>
	...
	<div class="container mt-3">
		...
		<h1 class="bg-success">Suscipit in inventore.</h1>
		<h1 class="bg-info">Ipsum pariatur labore?</h1>
		<h1 class="bg-warning">Itaque deserunt in.</h1>
		<h1 class="bg-danger text-white">Obcaecati nihil dignissimos.</h1>
		<h1 class="bg-secondary">Atque dignissimos esse?</h1>
		<h1 class="bg-dark-light">Facere corporis error?</h1>
		<h1 class="bg-light">Sunt ducimus qui?</h1>
	</div>
